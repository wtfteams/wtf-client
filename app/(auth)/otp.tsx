      ...
      <View className='flex-1 gap-20'>
        <View className='gap-5'>
          <View className='gap-2'>
            <Text className='font-poppins-semibold text-xl tracking-wider text-white'>Verification code</Text>
            <Text className='font-poppins-regular text-xs tracking-wider text-white'>we have send the verification code
            </Text>
            <Text className='text-white font-poppins-regular tracking-wider text-xs'>
              to +91 81****1234.
              <Text className='text-[#FFCD00]'
                onPress={() => router.back()}
